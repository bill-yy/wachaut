import { s as sanitize_props, a as spread_props, b as slot, o as head, q as attr, p as store_get, u as unsubscribe_stores } from "../../chunks/root.js";
...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    head("1uha8ag", $$renderer2, ($$renderer3) => {
      ...
      $$renderer3.push(`<meta name="description" content="Comparte tu pantalla con amigos sin registro. Crea una sala, comparte el enlace y listo."/>`);
    });
    $$renderer2.push(`<main class="flex min-h-screen flex-col gradient-hero"><nav class="w-full px-4 py-4"><div class="mx-auto flex max-w-5xl items-center justify-between"><div class="flex items-center gap-2.5"><div class="flex h-9 w-9 items-center justify-center rounded-xl bg-slate-800 shadow-lg shadow-slate-800/20">`);
